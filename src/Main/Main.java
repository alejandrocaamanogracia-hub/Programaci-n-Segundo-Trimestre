...
public class Main {
    public static void main(String[] args) {
        ...
        Jugador jugador1 = new Jugador("Juan", 23, "Normal", "Portero");
        Jugador jugador2 = new Jugador("Pablo", 27, "Normal", "otro");
        Jugador jugador3 = new Jugador("Mario", 21, "Irascible", "otro");

        Jugador jugador4 = new Jugador("Jose", 28, "Irascible", "otro");
        Jugador jugador5 = new Jugador("Rubén", 20, "Normal", "otro");
        Jugador jugador6 = new Jugador("Sebas", 25, "Calmado", "Portero");

        Jugador jugador7 = new Jugador("Alejandro", 23, "Calmado", "otro");
        Jugador jugador8 = new Jugador("Raúl", 27,"Calmado", "otro");
        Jugador jugador9 = new Jugador("Adrián", 21, "Normal", "Portero");

        Jugador jugador10 = new Jugador("Alvaro", 23, "Normal", "otro");
        Jugador jugador11 = new Jugador("Sergio", 27, "Calmado", "Portero");
        Jugador jugador12 = new Jugador("Daniel", 21,"Irascible", "otro");
